...
El proyecto está organizado de forma sencilla para separar el contenido, los estilos y los recursos gráficos utilizados en la interfaz.<br>
<code>
  Archesky/
  │
  ├── index.html
...
<code>
:root {<br>
  --primary-color: #7edad2;<br>
  --text-color: #424241;<br>
  --secondary-color: #909090;<br>
}
</code>
